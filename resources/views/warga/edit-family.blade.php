...
<div class="max-w-4xl mx-auto p-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Data Anggota Keluarga</h2>
            <a href="{{ route('warga.family.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg">
        ...
        <form method="POST" action="{{ route('warga.family.update', $resident->id) }}" class="space-y-6">
            @csrf
            @method('PUT')
