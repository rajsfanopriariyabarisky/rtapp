...
<body>
    ...
    <header class="absolute inset-x-0 top-0 z-50">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <a href="{{ route('warga.letters.index') }}" class="text-sm/6 font-semibold text-gray-900">Riwayat Surat</a>
            <a href="{{ route('iuran.history') }}" class="text-sm/6 font-semibold text-gray-900">Riwayat Iuran</a>
            <a href="#" class="text-sm/6 font-semibold text-gray-900">Marketplace</a>
            <a href="#" class="text-sm/6 font-semibold text-gray-900">Company</a>
            <form action="{{ route('iuran.pay') }}" method="POST">
                @csrf
                <input type="hidden" name="jumlah" value="50000">
                <button type="button" id="pay-button" class="bg-blue-600 text-white px-4 py-2 rounded">Bayar Sekarang</button>
            </form>
        </div>
        ...
        if (payButton) {
            payButton.addEventListener('click', function () {
                fetch("{{ route('iuran.pay') }}", {
                    ...
                    body: JSON.stringify({ jumlah: 50000 })
                })
