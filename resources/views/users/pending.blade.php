            ...
            <div class="flex items-center gap-2">
              ...
              >
                <form method="POST" action="{{ route('users.approve', $user->id) }}">
                    @csrf @method('PATCH')
                    <button type="submit" class="inline-flex items-center gap-2 px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-green-500 shadow-theme-xs hover:bg-green-600">Setujui</button>
                </form>

                <form method="POST" action="{{ route('users.reject', $user->id) }}">
                    @csrf @method('PATCH')
                    <button type="submit" class="inline-flex items-center gap-2 px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-red-500 shadow-theme-xs hover:bg-red-600">Tolak</button>
                </form>
              </p>
            </div>
          </td>
